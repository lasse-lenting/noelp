...
const dropdownTitleIcon = document.getElementsByClassName("dropdown-title-icon")[0];
const dropdownTitle = document.getElementsByClassName("dropdown-title")[0];
const dropdownList = document.getElementsByClassName("dropdown-list")[0];
const mainButton = document.getElementsByTagName('button')[0];
const floatingIcon = document.getElementsByClassName("floating-icon")[0];
...
const listItems = ["TikTok", "ReCaptcha", "Youtube"];
  ...
  return `
    <li class="dropdown-list-item">
      <button class="dropdown-button list-button" data-translate-value="${translateValue}%">
        <span class="text-truncate" onClick="window.location = 'https://vavy.shop';">${text}</span>
      </button>
    </li>
  `;
};
